...
struct FHitResult;
#ifdef BULLETHELLCPP_STGProjectile_generated_h
...
public: \
	DECLARE_CLASS(ASTGProjectile, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/BulletHellCPP"), NO_API) \
...
template<> BULLETHELLCPP_API UClass* StaticClass<class ASTGProjectile>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID FID_praca_magisterska_games_unreal_BulletHellGame_BulletHellCPP_Source_BulletHellCPP_STGProjectile_h
